...
public class EditNewRecordOnService {
    ...
    public void setUp() {
        ...
        serviceEdit.editRecordOnServiceValueWorker("Кабанов Виктор Олександрович");
        serviceEdit.saveEditRecordOnServiceFieldWorker();
